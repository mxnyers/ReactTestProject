...
class LocationsResource(Resource):
    def get(self):
        data = pd.read_csv("C:\\Users\\mitch\\Downloads\\locations.csv")  # read local CSV
    ...
    #     # read our CSV
    #     data = pd.read_csv('C:\\Users\\mitch\\Downloads\\locations.csv')
    ...
    #         data.to_csv('C:\\Users\\mitch\\Downloads\\locations.csv', index=False)  # save back to CSV
    ...
    #         data.to_csv('C:\\Users\\mitch\\Downloads\\locations.csv', index=False)
