...
class UsersResource(Resource):
    def get(self):
        data = pd.read_csv("C:\\Users\\mitch\\Downloads\\users.csv")
    ...
    #         data.to_csv('C:\\Users\\mitch\\Downloads\\users.csv', index=False)  # save back to CSV
    ...
    #         # save back to CSV
    #         data.to_csv('C:\\Users\\mitch\\Downloads\\users.csv', index=False)
